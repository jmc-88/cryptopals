...
int main() {
  ...
  constexpr auto kInput1 = "1c0111001f010100061a024b53535009181c"sv;
  constexpr auto kInput2 = "686974207468652062756c6c277320657965"sv;
  constexpr auto kExpected = "746865206b696420646f6e277420706c6179"sv;
